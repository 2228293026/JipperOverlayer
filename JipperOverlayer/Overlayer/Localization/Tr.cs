...
public static class Tr
{
    public enum Key
    {
        ...
        Alignment, AlignMain, AlignBpm, AlignJudge, AlignCombo, AlignComboVal, AlignTiming, AlignAttempt, ApplyAlignment, AlignReset,
    ...
    [
        /* 0  English */ [ "Size", "Show Progress", "Show Accuracy", "Show XAccuracy",
            ...
            "Alignment", "Main", "BPM", "Judge", "Combo Title", "Combo Value", "Timing Scale", "Attempt", "Apply Alignment", "Reset",
        ...
        /* 1  Korean */ [ "크기", "진행도 표시", "정확도 표시", "X정확도 표시",
            ...
            "언어",
            "글꼴", "사용자 지정 위치", "위치 초기화",
            "텍스트 정렬", "메인", "BPM", "판정", "콤보 제목", "콤보 값", "타이밍 스케일", "시도", "정렬 적용", "초기화",
        ...
        /* 2  Chinese */ [ "大小", "显示进度", "显示准确率", "显示X准确率",
            ...
            "语言",
            "字体", "自定义位置", "重置位置",
            "文本对齐", "主区域", "BPM", "判定", "连击标题", "连击数值", "时机缩放", "尝试", "应用对齐", "重置",
            "进度颜色", "准确率颜色", "X准确率颜色",
            "音乐时间颜色", "地图时间颜色", "最佳颜色",
